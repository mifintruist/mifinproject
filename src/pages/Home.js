...
<div className="about"  ref={aboutref}style={{backgroundColor:'aliceblue',margin:"20px 0px"}}>
  <br />
   ...
   <p style={{textAlign:"left",margin:"5%"}}> Mifintruist is a New York City-based company founded in 2006 by David Schmitt and Partners, offers a diverse and splendid investment portfolio opportunity to those looking to invest in our firm. We deliver investors modern ways of increasing value of assets dedicated to our company through a united states treasury bonds making sure that we gurantee investors with safe returns and reliable investment portfolios. Mifintruist uses a sophisticated blockchain techonoly to ensure security and investors confidence which also makes investment easy and straight forward for on-looking and potential investors. We based our ideology primaryly on client satisaction because which aim at exceeding your expectations and we go stellar length to provide you with an adequate investment environment. The modern company must be data-driven, innovative, able to scale and respond to market dynamics rapidly. We have perfected on this and therefore created a platform to make sure your investment goals are reached and in addition we have made our investment portfolio easy to navigate. We cater to the investment needs of individuals, pension and profit sharing plans, trusts, and business entities and is proud to do business with our clients. Our mission is to provide timely, accurate and pertinent value added financial services to our high net worth clients.</p>
<br />
