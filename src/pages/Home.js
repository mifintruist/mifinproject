...
console.log("ref",refid);
  return (
    <div >
     ...
     <div className="section-padding-30 wf-section"><div className="custom-container"><div className="spacer-30"></div><div className="crypto-explanation"><div className="crypto-explanation-texts"><div className="crypto-explanation-title"><h2>The Easiest way to invest <span className="text-span">in blockchain ledgers and build your cryptocurrency portfolio and <br/>digital wealth</span></h2></div><div className="crypto-explanation-description"><div className="crypto-explanation-details"><p>Investing in cryptocurrency can be intimidating, especially for beginners. Sometimes managing a crypto investment is daunting due to the uncertainty and volatility of the market, as well as the time investment needed to be successful.</p></div></div></div></div></div></div>
          ...
          <div className="contacts contact-wrapper">
            <ul>
              ...
              <span className="hightlight-contact-info">
                ...
                <li><i className="fa fa-phone" aria-hidden="true" /> <span className="highlight-text"  style={{fontSize:'12px'}}>1 747 208 3210</span></li>
